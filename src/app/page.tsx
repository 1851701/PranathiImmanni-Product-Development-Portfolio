...
import { AboutBelowWorksSection } from "@/components/home/about-below-works";
...
export default function HomePage() {
  ...
  return (
    <div className="pb-28 lg:pb-36">
      ...
      <div className="mx-auto max-w-6xl px-6 pt-20 sm:px-8 lg:px-10 lg:pt-28">
